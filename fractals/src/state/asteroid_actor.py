...
from fractals.src.constants.game_constants import (
    GAME_WIDTH_PX,
...
from fractals.src.interfaces.actor import Actor
from fractals.src.util.polygons import generate_polygon
