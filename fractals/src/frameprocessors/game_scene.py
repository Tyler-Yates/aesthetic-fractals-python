...
from fractals.src.constants.game_constants import MAXIMUM_ASTEROID_SIZE
from fractals.src.constants.scene_enum import SceneEnum
from fractals.src.interfaces.scene import Scene
from fractals.src.state.asteroid_actor import Asteroid
from fractals.src.state.game_state import GameState
from fractals.src.util.fonts import BASIC_FONT, render_with_outline
from fractals.src.util.polygons import collides
